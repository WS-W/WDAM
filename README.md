...
[![paper](https://img.shields.io/badge/arXiv-Paper-<COLOR>.svg)](https://arxiv.org/abs/2603.02964) 
<!-- [![Model](https://img.shields.io/badge/GoogleDrive-Weight-blue)](https://drive.google.com/drive/folders/1Rjb8dpyNnvvr0XLvIX9fg8Hdru_MhMCj?usp=sharing) [![Model](https://img.shields.io/badge/BaiduNetdisk-Weight-blue)](https://pan.baidu.com/s/1retfKIs_Om-D4zA45sL6Kg?pwd=dcyb) -->
...
## 📌 Overview
Architecture of our proposed WDAM module.
<img src="fig/WDAM.png" alt="Architecture" style="zoom:20%;" />

The architecture of CutPaste with the proposed WDAM.
<img src="fig/cutpaste_wdam.png" alt="Architecture" style="zoom:12%;" />

Illustration of the proposed foundation model-based anomaly synthesis pipeline (FMAS).
<img src="fig/synthesis_pipeline.png" alt="Architecture" style="zoom:12%;" />

Qualitative results showing anomaly samples generated by the proposed FMAS on the MVTec AD dataset
<img src="fig/mvtec_ad_generated.png" alt="Architecture" style="zoom:12%;" />

Evaluation results of CutPaste and our variants on MVTec AD dataset.
<img src="fig/res_mvtec.png" alt="Results" style="zoom:50%;" />
